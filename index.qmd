...
- Este relatório tem como objetivo a criação de um trabalho acadêmico utilizando a ferramenta Quarto, com saída em HTML.. O projeto foi desenvolvido no sistema Windows, utilizando a IDE Positron, que oferece suporte nativo ao Quarto e facilita a edição dos arquivos .qmd. O modelo escolhido foi o Tufte,-style por seu design limpo e foco em conteúdo técnico.
Durante o processo, foram aplicados conceitos fundamentais de Git e GitHub para versionamento e publicação do projeto em um repositório online. Também foi utilizado o pip, gerenciador de pacotes do Python, para instalar bibliotecas como **pandas, numpy, matplotlib e requests**. A linguagem Python foi empregada com foco em seus conceitos iniciais, como **tipos de dados, estruturas de controle, funções e boas práticas de codificação**.
---
